...
<div class="section-body">
    <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        @endif
<form action=" {{route('postupdatemahasiswa',$mahasiswa->id)}} " method="post" id="form-edit">
          @csrf
<div class="row"> 
  <div class="col-md-12">
    <input type="hidden" name="id" value=" {{ $mahasiswa->id }} " id="id_data">
    <div class="form-group">
      ...
      <input type="text" name="email" value=" {{ $mahasiswa->email }}" class="form-control">
            ...
            <a class="btn btn-secondary" href="{{route('mahasiswa')}}" role="button">Close</a>
