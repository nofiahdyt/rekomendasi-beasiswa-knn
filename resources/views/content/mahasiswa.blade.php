...
<div class="section-body">
    <div class="row">
    	<div class="col-12 col-md-12 col-lg-12">
          <a href =" {{route ('createmahasiswa')}} " class="btn btn-primary" data-target="form-tambah">Tambah Data</a>
    		...
    		<table class="table table-striped table-bordered table-sm">
    			...
    			@foreach ($mahasiswa as $no => $mhs)
    				<tr>
                        ...
                        <td>{{ $mhs->ipk }}</td>
                        <td>{{ $mhs->penghasilan }}</td>
                        <td>{{ $mhs->email }}</td>
    					          <td>
                          <a href="{{route('updatemahasiswa',$mhs->id)}}"  class="badge badge-success btn-edit">Edit</a>
                          <a href="{{route('deletemahasiswa',$mhs->id)}}" class="badge badge-danger btn-edit">Hapus</a>     
                              @csrf
                              @method('delete')
                            </form>
                        </a>
