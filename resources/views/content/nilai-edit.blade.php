...
<div class="section-body">
    <div class="row">
      <div class="col-12 col-md-12 col-lg-12">
        ...
        @endif
<form action=" {{route('postupdatenilai',$nilai->id)}} " method="post" id="form-edit">
          @csrf
<div class="row"> 
  <div class="col-md-12">
    <input type="hidden" name="id" value=" {{ $nilai->id }} " id="id_data">
    <div class="form-group">
      ...
      <input type="number" name="sks" value=" {{ $mk->sks }}" class="form-control">    
            ...
            <a class="btn btn-secondary" href="{{route('nilai')}}" role="button">Close</a>
